...
//	});
	...
	$('.menu-activated-on-hover').on('click', 'li.has-sub-menu > a', function (event) {
...
$(function () {
	...
	//  var table  = $('#dataTable1').DataTable({ buttons: ['copy', 'excel', 'pdf'] });
	// }
	// #6. EDITABLE TABLES
	...
	if (typeof Chart !== 'undefined') {
		...
		if ($("#donutChart").length) {
			...
			// donut chart data
			var data = {
				labels: ["Invoices", "Expenses"],
				datasets: [{
					data: [180, 180],
					backgroundColor: ["#157FCC", "#8FC038"],
					hoverBackgroundColor: ["#0E4369", "#4E740C"],
					borderWidth: 0
				}]
			};
